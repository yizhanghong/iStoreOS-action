...
# openclash 的 dev内核
CLASH_DEV_URL="https://bgithub.xyz/vernesong/OpenClash/raw/core/master/dev/clash-linux-amd64.tar.gz"

# openclash 的 TUN内核
CLASH_TUN_VERSION=$(curl -sL https://github.com/vernesong/OpenClash/raw/core/master/core_version | head -n 2 | tail -n 1)
CLASH_TUN_URL="https://bgithub.xyz/vernesong/OpenClash/raw/core/master/premium/clash-linux-amd64-$CLASH_TUN_VERSION.gz"
# openclash 的 Meta内核版本
# CLASH_META_URL="https://bgithub.xyz/vernesong/OpenClash/raw/core/master/meta/clash-linux-amd64.tar.gz"
...
# CLASH_DEV_URL="https://raw.bgithub.xyz/vernesong/OpenClash/master/core-lateset/dev/clash-linux-arm64.tar.gz"
...
# CLASH_META_URL="https://raw.bgithub.xyz/vernesong/OpenClash/master/core-lateset/meta/clash-linux-${1}.tar.gz"
...
# GEOIP_URL="https://bgithub.xyz/Loyalsoldier/v2ray-rules-dat/releases/latest/download/geoip.dat"
# GEOSITE_URL="https://bgithub.xyz/Loyalsoldier/v2ray-rules-dat/releases/latest/download/geosite.dat"
...
# Country.mmdb
# COUNTRY_LITE_URL=https://raw.bgithub.xyz/alecthw/mmdb_china_ip_list/release/lite/Country.mmdb
# COUNTRY_FULL_URL=https://raw.bgithub.xyz/alecthw/mmdb_china_ip_list/release/Country.mmdb
